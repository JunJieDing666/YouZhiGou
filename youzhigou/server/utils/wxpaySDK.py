...
class WxPayConf_pub(object):
    ...
    APPID = "wxab0ea199a27ef546"
    # JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    APPSECRET = "06d3cd372cf08c1f9cd98de87b4d7ec9"
    # 受理商ID，身份标识
    MCHID = "1230980902"
    # 商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = "gty213gty213gty213gty213gty213gt"

    # =======【异步通知url设置】===================================
    # 异步通知url，商户根据实际开发过程设定
    NOTIFY_URL = "mgmt.uzhigou.com/wxpay/pay-bill"
...
class UnifiedOrder_pub(Wxpay_client_pub):
    ...
    def createXml(self):
        ...
        self.parameters["sign"] = self.getSign(self.parameters)  # 签名
        self.parameters["notify_url"] = "http://mgmt.uzhigou.com/wxpay/result"
        return self.arrayToXml(self.parameters)
